...
export default function Header() {
  ...
  const { language, switchLanguage, toggleLanguage, t } = useLanguage();
      ...
      <div className="gov-top-bar py-1 px-3 d-none d-md-block">
        <div className="container-fluid d-flex justify-content-between align-items-center">
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            {/* Bilingual Language Switcher (Explicit English & हिन्दी buttons) */}
            <div className="btn-group btn-group-sm no-translate border border-secondary rounded overflow-hidden shadow-sm" role="group" aria-label="Portal Language">
              <button
                ...
                className={`btn btn-sm py-0 px-2.5 fw-bold no-translate ${
                  language === 'EN'
                    ? 'btn-warning text-dark shadow-sm'
                    : 'btn-outline-light border-0 text-white-50'
                }`}
                style={{ fontSize: '0.78rem' }}
                title="View Portal in English"
              >
                English
              </button>
              <button
                ...
                onClick={() => {
                  switchLanguage('HI');
                  showToast('भाषा को हिन्दी में बदला गया (Language switched to Hindi)', 'info');
                }}
                className={`btn btn-sm py-0 px-2.5 fw-bold no-translate ${
                  language === 'HI'
                    ? 'btn-warning text-dark shadow-sm'
                ...
                style={{ fontSize: '0.78rem' }}
                title="पोर्टल को हिन्दी में देखें"
              >
                हिन्दी
              </button>
            </div>
